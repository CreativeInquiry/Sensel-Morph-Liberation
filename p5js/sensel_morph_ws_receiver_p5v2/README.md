# sensel_morph_ws_receiver_p5v2

p5.js 2.x browser receiver for `sensel_morph_ws` or the Processing
...
```sh
cd /Users/gl/Desktop/sensel/p5js/sensel_morph_ws_receiver_p5v2
