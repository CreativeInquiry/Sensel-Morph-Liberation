...
// streams; and broadcasts them as OSC. This app does not require Python, 
// oscP5, or the Sensel SDK.
//
...
// is running. Press c to toggle calibration when a matching
...
void setup() {
  ...
  surface.setTitle("Sensel Morph OSC Transmitter");
  noSmooth();
  frameRate(60);
